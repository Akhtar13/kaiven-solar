...
function loadMoreContent() {
    ...
    setTimeout(function () {
        axios
            .post(APP_URL + '/get-service-inbox', {page: page})
...
$(".search-box").on('keyup', function () {
    ...
    getInbox(query, service_id)
})
const getInbox = (query = '', service_id) => {
    axios
        .post(APP_URL + '/get-service-inbox', {query: query, service_id: service_id})
        .then(function (response) {
...
$(document).on('click', ".chat-details", function () {
    ...
    getChatDetails(service_user_id)
})

const getChatDetails = (service_user_id) => {
...
const allMessagesCollectionRef = collectionGroup(db, "messages")
const new_service_id=$("#service_id").val()
console.log(new_service_id)
const queryRef = query(
    allMessagesCollectionRef,
    where("service_id", "==", new_service_id),
    orderBy("time")
);
