            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">{{trans('messages.address_types_edit')}}</h5>
                    </div>

                    <div class="card-body">
                        <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                            @csrf
                            <input type="hidden" id="edit_value" value="{{ $address_types->id }}" name="edit_value">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4"
                                            placeholder="{{trans('messages.description')}}">{{ $address_types->description }}</textarea>
                                </div>
