        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">{{trans('messages.add_setting')}}</h5>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="meta_key" name="meta_key" placeholder="{{trans('messages.meta_key')}}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="meta_value" name="meta_value" placeholder="{{trans('messages.meta_value')}}">
                            </div>
                        </div>
                        <div class="text-end">
